      ...
      <el-row :gutter="10">
        <el-col :span="3">
          <el-form-item :label="'部门'">
            <el-input v-model="search.dept" placeholder="部门"/>
          </el-form-item>
        </el-col>
        <el-col :span="3">
          <el-form-item :label="'用工类型'">
            <el-input v-model="search.empType" placeholder="用工类型"/>
          </el-form-item>
        </el-col>
...
export default {
  ...
  mounted() {
    this.fileUrl = `/chengtou/labor/input`
  ...
  methods: {
    ...
    qFilter() {
      let obj = {}
      this.search.dept != null && this.search.dept != '' ? obj.dept = this.search.dept : null
      this.search.empType != null && this.search.empType != '' ? obj.empType = this.search.empType : null
